...
contract CShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 cSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("CFNSHARE", "CSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 CFN Share for initial pools deployment
